                ...
                <section className="ftco-section">
                    <div className="container">
                        <div className="row d-flex justify-content-center">
                            ...
                            <div className="col-md-12 text-center d-flex " data-aos="fade-up">
                                <div className="blog-entry justify-content-end mb-md-5">
                                    <a href="blog-single.html" className="block-20 img" style={{ backgroundImage: 'url("images/image_5.jpg")' }}>
                                    </a>
                                    <div className="text px-md-5 pt-4">
                                        <div className="meta mb-3">
                                            <div><a href="#">Oct. 29, 2019</a></div>
                            ...
                            <div className="col-md-12 text-center d-flex " data-aos="fade-up">
                                <div className="blog-entry">
                                    <a href="blog-single.html" className="block-20 img" style={{ backgroundImage: 'url("images/image_6.jpg")' }}>
                                    </a>
                                    <div className="text px-md-5 pt-4">
                                        <div className="meta mb-3">
                                            <div><a href="#">Oct. 29, 2019</a></div>
