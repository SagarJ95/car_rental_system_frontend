                    ...
                    <div className="container">
                        <div className="row no-gutters slider-text js-fullheight align-items-end justify-content-start">
                            <div className="col-md-9  pb-5" data-aos="fade-up">
                                <p className="breadcrumbs"><span className="mr-2"><a href="index.html">Home <i className="ion-ios-arrow-forward" /></a></span> <span className="mr-2"><a href="blog.html">Blog <i className="ion-ios-arrow-forward" /></a></span> <span>Blog Single <i className="ion-ios-arrow-forward" /></span></p>
                ...
                <section className="ftco-section ftco-degree-bg">
                    <div className="container">
                        <div className="row">
                            ...
                            <div className="col-md-4 sidebar " data-aos="fade-up">
                                ...
                                <div className="sidebar-box " data-aos="fade-up">
                                    ...
                                    <div className="block-21 mb-4 d-flex">
                                        ...
                                        <div className="text">
                                            ...
                                            <div className="meta">
                                                <div><a href="#"><span className="icon-calendar" />Oct. 29, 2019</a></div>
                                ...
                                <div className="sidebar-box 0" data-aos="fade-up">
                                    <h3>Paragraph</h3>
                                    <p>Lorem ipsum dolor sit amet, consectetur adipisicing elit. Ducimus itaque, autem necessitatibus voluptate quod mollitia delectus aut, sunt placeat nam vero culpa sapiente consectetur similique, inventore eos fugit cupiditate numquam!</p>
                                </div>
                            </div>
...
export default Blogs_description